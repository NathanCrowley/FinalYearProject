...
## ****** currently only 2 set venn diagram ****
	...
	def __init__(self,subsets,labels):
		...
		if self.number_of_sets == 3: # 3 set Venn diagram
			if self.unweighted == False:
				self.venn_diagram_3 = venn3(subsets=self.subsets, set_labels=self.labels) # create the venn diagram objects - so they can be called at the print stage
